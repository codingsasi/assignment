...
$orders = $pdo->query(
    'SELECT o.*, u.name AS user_name, u.email AS user_email FROM orders o JOIN users u ON u.id = o.user_id ORDER BY o.order_date DESC'
)->fetchAll();
...
<div class="card mb-3">
  <div class="card-header d-flex justify-content-between flex-wrap gap-2">
    <span>Order #<?php echo (int) $o['id']; ?> — <?php echo htmlspecialchars($o['user_name']); ?> (<?php echo htmlspecialchars($o['user_email']); ?>)</span>
